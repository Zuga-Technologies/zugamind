...
def load_budget() -> dict:
    """Load today's budget tracking, resetting counters on a new day.

    Shape: {date, spent, paid_spent, calls: {local, haiku, sonnet, opus}, remaining}.
    """
    ...
    # New day (or first boot) — fresh counters against the full monthly cap.
    return {
        "date": today,
        "spent": 0.0,
        "paid_spent": 0.0,
