...
Nothing in THIS repo imports these yet — the origin project's internal
extension modules (which consumed them) were deliberately not extracted for
the OSS release. The helpers ship anyway because they are the supported
seam for third-party modules: write a WorkspaceModule subclass, gate it with
`gate_enabled`, and call `self_register` from your module's import.
